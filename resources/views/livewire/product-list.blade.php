...
<div class="container px-6 mx-auto">
	...
	@if (!$searchNull || !$sectionNull)
		...
		<a wire:navigation href="{{ route('products.index') }}"
			class="block w-30 text-center  text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-l-lg font-medium px-2 py-1  items-center">
			Limpiar filtros
		</a>
	@endif
	...
	@else
		<x-mary-alert title="Sin Elementos" icon="o-exclamation-triangle" class="alert-info alert-soft" />
	@endif
