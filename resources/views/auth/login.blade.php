        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="inline-flex items-center group cursor-pointer">
                <input
                    id="remember_me"
                    type="checkbox"
                    class="rounded-lg border-base-content/10 text-red-600 shadow-sm focus:ring-red-600/20"
                    name="remember">
                <span
                    class="ms-2 text-xs font-bold uppercase tracking-widest text-base-content/40 group-hover:text-red-600 transition-colors">
                    Recordarme
                </span>
            </label>
            ...
            @if (Route::has('password.request'))
                <a
                    class="text-xs font-bold text-base-content/40 hover:text-red-600 transition-colors"
